	...
	do
	{
		...
		do
		{
			...
			do
			{
				...
				if (attempts == 7)
				{
					printf("\nYou have 7 attempts to enter the password. All the best SUPERHERO!!!\n");
				}
				blue();
				printf("\n\tEnter the password :\t GUESS7");
				scanf("%d", &guess);
			...
			else
			{
				...
				purple();
				printf("The Password Was : GUESS7");
				yellow();
				printf("%d\n\n", number);
				green();
				printf("Would you like to play again?(Password Can Be Different )\n(enter 1 for YES and 0 for NO ) :\t");
				scanf("%d", &choice);
			}
